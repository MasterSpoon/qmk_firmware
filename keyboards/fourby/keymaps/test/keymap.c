...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        RANDOM_STRING_MACRO, RANDOM_STRING_MACRO, RANDOM_STRING_MACRO, RANDOM_STRING_MACRO,
		RANDOM_STRING_MACRO, RANDOM_STRING_MACRO, RANDOM_STRING_MACRO, RANDOM_STRING_MACRO,
		RANDOM_STRING_MACRO, RANDOM_STRING_MACRO, RANDOM_STRING_MACRO, RANDOM_STRING_MACRO,
		RANDOM_STRING_MACRO, RANDOM_STRING_MACRO, RANDOM_STRING_MACRO, RANDOM_STRING_MACRO
    )
    ...
    if (record->event.pressed) {
        ...
        switch (keycode) {
            case RANDOM_STRING_MACRO:
                send_string_with_delay_P((PGM_P)pgm_read_ptr(&(sentences[i])), RANDOM_STRING_DELAY);
                tap_code(KC_ENT);
