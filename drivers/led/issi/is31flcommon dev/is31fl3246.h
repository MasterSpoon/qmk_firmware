...
// Register Functions
#define ISSI_REG_CONTROL 0x00
#define ISSI_REG_HIGH_PWM_1ST 0x01 // High Frequency PWM (2 registers per LED)
#define ISSI_PWM_REG_1ST 0x49 //Low Frequency PWM
#define ISSI_REG_UPDATE 0x6D
#define ISSI_UPDATE 0x00
#define ISSI_SCL_REG_1ST 0x6E // Global Current Control Registers
#define ISSI_REG_PHASE 0x71
#define ISSI_REG_RESET 0x7F

// Set defaults for Register Functions
#ifndef ISSI_CONTROL
#    define ISSI_CONTROL 0x01
#endif
#ifndef ISSI_HIGH_PWM_HFP_L
#    define ISSI_HIGH_PWM_HFP_L 0xFF
#endif
#ifndef ISSI_HIGH_PWM_HFP_H
#    define ISSI_HIGH_PWM_HFP_H 0x00
#endif
#ifndef ISSI_PHASE
#    define ISSI_PHASE 0x00
#endif

// Set defaults for Global Current Control Registers
